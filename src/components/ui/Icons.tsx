...
interface IconProps { className?: string; size?: number; style?: CSSProperties }
...
export function ChurchIcon({ className, size = 20 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={cn('shrink-0', className)}>
      <path d="M12 2v10" /><path d="M9 4h6" /><path d="M4 22V8l8-6 8 6v14" /><path d="M4 22h16" /><path d="M9 12h6" /><path d="M9 18h6" /><path d="M9 15h6" />
    </svg>
  )
}
...
export function DoorIcon({ className, size = 20 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={cn('shrink-0', className)}>
      <path d="M14 2v4a2 2 0 0 0 2 2h4" /><path d="M5 12h.01M12 12h.01M19 12h.01" /><path d="M5 22h14a2 2 0 0 0 2-2V7l-5-5H5a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2z" />
    </svg>
  )
}
...
export function SparkleIcon({ className, size = 20 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={cn('shrink-0', className)}>
      <path d="M12 3l1.5 5.5L19 10l-5.5 1.5L12 17l-1.5-5.5L5 10l5.5-1.5z" /><path d="M18 14l1 2.5L21 18l-2.5 1L18 21l-1-2.5L14 18l2.5-1z" /><path d="M6 14l1 2.5L9 18l-2.5 1L6 21l-1-2.5L2 18l2.5-1z" />
    </svg>
  )
}
